"""
Solved using hash_extender:
hash_extender \
  --data 'username=saphex&value=10' \
  --secret 16 \
  --append '&value=1000' \
  --signature f681d615a0cc191edf2845a8b20384c088cca049c7ab70467f19226ad87fb830 \
  --format sha256
"""
...
def buy(coupon: str, mac_hex: str) -> str:
    ...
    try:
        fields = dict(kv.split(b"=", 1) for kv in coupon.split(b"&") if b"=" in kv)
